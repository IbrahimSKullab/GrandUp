...
class SliderRequestRejectedNotification extends Notification
{
    ...
    {
        return [
            'ar' => 'تمت رفض  نشر إعلانك',
            'en' => 'Your offer request has been rejected for publication',
        ];
    }
    ...
    {
        return [
            'ar' => $this->productAdsSlider->rejection_reason,
            'en' => $this->productAdsSlider->rejection_reason,
        ];
    }
