...
class GiftOrderApprovedNotification extends Notification
{
    ...
    {
        return [
            'ar' => 'تم قبول طلب الهدية من قبل الإدارة',
            'en' => 'The gift request has been accepted by the administration',
        ];
    }
