...
class RequestBlueTagApprovedNotification extends Notification
{
    protected BlueTag $request_blue_tag;
    ...
    {
        return [
            'ar' => 'تمت الموافقة على العلامة الزرقاء',
            'en' => 'Blue tag request approved',
        ];
    }
