...
class SharedProductApprovedNotification extends Notification
{
    private SharedProductApprovedNotification $shared_product_approved_notification;
    ...
    {
        return [
            'ar' => 'تم قبول مشاركة المنتج'. $this->product_shared->sellerProduct->title .' من قبل التاجر '. $this->product_shared->seller->name .'',
            'en' => 'Product sharing accepted'. $this->product_shared->sellerProduct->title .' by the seller '. $this->product_shared->seller->name .'',
        ];
    }
}
